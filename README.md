...
Installer chrome assets (header / sidebar BMPs + plain-text MIT license) live under `frontend/src-tauri/entropia-orme/installer/` and are wired through `bundle.windows.nsis` in `frontend/src-tauri/entropia-orme/tauri.conf.json`.
