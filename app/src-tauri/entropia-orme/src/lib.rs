...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::protection_set_restore,
            commands::protection_undo,
            commands::protection_unrecorded_sessions,
            commands::protection_session_status,
            commands::protection_recording_candidates,
            commands::protection_observation_confirm,
            commands::protection_repair_confirm,
            commands::protection_trade_terminal_scan,
            commands::healing_outputs,
            commands::healing_correction_tools,
            commands::healing_correct,
            commands::healing_correction_undo,
            commands::weapon_shots,
            ...
            commands::consumable_doses,
            commands::consumable_dose_start,
            commands::consumable_dose_remove,
            commands::consumable_dose_restore,
            commands::consumable_session_doses,
            ...
            commands::tracking_weapon_decide,
