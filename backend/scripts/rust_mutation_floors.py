...
FLOORS: dict[str, float] = {
    ...
    # Measured 96.7. The residual survivors are equivalent: the dead
    ...
    # way). The cross-language differential drives the same loops
    # against the backend over the real snapshots.
