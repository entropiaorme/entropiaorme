...
| `quest_service` | Quest and playlist CRUD, completion, reward suppression. | `e2e/test_consistency_quests_mission_lifecycle_midpoint.py`<br>`e2e/test_quest_automation_with_playlist_match.py`<br>`test_mut_quest_service__c0.py`<br>`test_mut_quest_service__c1.py`<br>`test_mut_quest_service__c2.py`<br>`test_mut_quest_service__c3.py`<br>`test_mut_quest_service__c4.py`<br>`test_mut_quest_service__c5.py`<br>`test_mut_quest_service__c6.py`<br>`test_mut_quest_service__c7.py`<br>`test_mut_quest_service__c8.py`<br>`test_quest_service_properties.py`<br>`test_quests.py` | branch coverage + mutation |
