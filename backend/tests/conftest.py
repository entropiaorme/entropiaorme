...
_MODULE_TIERS = {
    ...
    # Two real backend subprocesses per scenario, boots overlapped; sits with
    # the single-process control above so the per-push gate exercises the
    # whole external drive surface on both platforms.
