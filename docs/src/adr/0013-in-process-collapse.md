...
- The first-launch database upgrade the sidecar used to perform (migrating a pre-baseline schema forward) no longer happens in-process; carrying that forward natively is deferred future work, out of scope for the collapse.
